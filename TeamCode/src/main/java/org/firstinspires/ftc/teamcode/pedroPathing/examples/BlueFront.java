...
public class BlueFront extends OpMode {
    ...
    private final Pose startPose = new Pose(24.580, 122.902, Math.toRadians(0));
    private final Pose endPose = new Pose(50.595, 70.259, Math.toRadians(0));
    ...
    public void init() {
        ...
        Point p1 = new Point(44.040, 84.393);
        Point p2 = new Point(15.772, 82.754);
        Point p3 = new Point(70.464, 79.477);
        Point p4 = new Point(37.690, 59.812);
        Point p5 = new Point(14.748, 60.017);
        Point p6 = new Point(71.488, 79.886);
        Point p7 = new Point(44.654, 35.437);
        Point p8 = new Point(14.953, 35.437);
        Point p9 = new Point(71.693, 81.935);
