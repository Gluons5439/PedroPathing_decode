...
public class RedFront extends OpMode {
    ...
    private final Pose startPose = new Pose(120.000, 120.000, Math.toRadians(0));
    private final Pose endPose = new Pose(97.502, 68.211, Math.toRadians(0));
    ...
    public void init() {
        ...
        Point p1 = new Point(99.141, 83.164);
        Point p2 = new Point(128.637, 83.573);
        Point p3 = new Point(71.898, 80.296);
        Point p4 = new Point(104.467, 59.812);
        Point p5 = new Point(129.252, 59.403);
        Point p6 = new Point(71.283, 79.886);
        Point p7 = new Point(99.346, 35.437);
        Point p8 = new Point(133.349, 35.437);
        Point p9 = new Point(72.102, 80.091);
        Point p10 = new Point(endPose);                // End

        bezierPath = new Path(new BezierCurve(p0, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10));
