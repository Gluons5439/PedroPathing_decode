...
public class ExampleRobotCentricTeleop extends OpMode {
    ...
    private boolean y_was_pressed = false;
    ...
    public void loop() {
        ...
        telemetry.addData("Shooter Power", shooterMotor != null ? shooterMotor.getPower() : 0.0);
    ...
    private void handleIntakeControl() {
        ...
        boolean y_is_pressed = gamepad2.y;

        if (y_is_pressed && !y_was_pressed) {
            intakeActive = !intakeActive;
        }
        y_was_pressed = y_is_pressed;

        intakeMotor.setPower(intakeActive ? INTAKE_POWER : 0.0);
    }
...
public class ExampleRobotCentricTeleop extends OpMode {
    ...
    public void loop() {
        ...
        handleShooterControl();  // UPDATED toggle logic
        handleIntakeControl();   // UPDATED controller 1 control
