...
public class RedBack extends OpMode {
    ...
    private final Pose startPose = new Pose(86.000, 8.000, Math.toRadians(0));
    private final Pose endPose = new Pose(92.791, 63.499, Math.toRadians(0));
    ...
    public void init() {
        ...
        Point p1 = new Point(104.876, 35.232);
        Point p2 = new Point(130.071, 35.027);
        Point p3 = new Point(71.488, 76.814);
        Point p4 = new Point(104.057, 58.993);
        Point p5 = new Point(130.276, 59.403);
        Point p6 = new Point(77.018, 83.983);
        Point p7 = new Point(128.842, 83.573);
        Point p8 = new Point(76.404, 83.368);
        Point p9 = new Point(endPose);                          // End

        bezierPath = new Path(new BezierCurve(p0, p1, p2, p3, p4, p5, p6, p7, p8, p9));  // Bezier curve
        bezierPath.setConstantHeadingInterpolation(startPose.getHeading());
    }
