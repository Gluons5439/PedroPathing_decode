...
public class FConstants {
    static {
        ...
        FollowerConstants.xMovement = 59.8331;
        FollowerConstants.yMovement = 50.782725;

        FollowerConstants.forwardZeroPowerAcceleration = -35.6112167;
        FollowerConstants.lateralZeroPowerAcceleration = -54.29500;
        ...
        FollowerConstants.drivePIDFCoefficients.setCoefficients(0.01, 0, 0.0000005, 0.6, 0);
        FollowerConstants.useSecondaryDrivePID = false;
        FollowerConstants.secondaryDrivePIDFCoefficients.setCoefficients(0.1, 0, 0, 0.6, 0); // Not being used, @see useSecondaryDrivePID

        FollowerConstants.zeroPowerAccelerationMultiplier = 3;
        FollowerConstants.centripetalScaling = 0.000095;
